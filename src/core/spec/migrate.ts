...
import { type OsqConfig, loadConfig } from '../foundation/config.js';
import { getNextSpecNumber } from '../foundation/new.js';
import { getArchiveDir, getChangesDir, getSpecsDir } from '../status/layout.js';
